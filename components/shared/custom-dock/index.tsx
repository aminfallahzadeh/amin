...
import { ModeToggle } from "@/components/shared/custom-dock/mode-toggle";
...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: GITHUB_BUTTON_TEXT,
        url: "https://github.com/aminfallahzadeh",
        icon: Icons.github,
      },
      LinkedIn: {
        name: LINKEDIN_BUTTON_TEXT,
        url: "https://linkedin.com/in/aminfallahzadeh",
        icon: Icons.linkedin,
      },
      email: {
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      {isActive && (
                        <div className="absolute bottom-2 size-1 rounded-full bg-black dark:bg-white" />
                      )}
                    </Link>
                  </TooltipTrigger>
                  <TooltipContent>
